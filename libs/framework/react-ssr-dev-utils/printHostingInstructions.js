...
function printHostingInstructions(assetsPath, buildFolder) {
    ...
    if (assetsPath.startsWith("/")) {
        console.log("All of your static assets will be served from the rendering server.")
        console.log("We recommend serving static assets from a CDN in production.")
        console.log(`You can control this with the ${chalk.cyan("ASSETS_PATH")} environment variable.`)
        console.log()
    }
