...
app.use(
    proxy("http://localhost:3005", {
        userResDecorator: (proxyRes, proxyResData, userReq) => {
            return proxyRes.headers["content-type"] && proxyRes.headers["content-type"].includes("html")
                ? esi.process(proxyResData.toString(), {
                      headers: {
                          ...
                          "x-monorepo-time-machine-date": userReq.headers["x-monorepo-time-machine-date"],
