...
describe("FadeInAnimation", () => {
    it("should show children when in on state", () => {
        ...
        const {asFragment, getByText} = render(<FadeInAnimation {...props}> <div>ciao mamma</div> </FadeInAnimation>)
    ...
    it("should not show children when in off state", () => {
        ...
        const {queryByText} = render(<FadeInAnimation {...props}> <div>ciao mamma</div> </FadeInAnimation>)
