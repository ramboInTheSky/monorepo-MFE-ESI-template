...
const ModuleScopePlugin = require("@monorepo/react-ssr-dev-utils/ModuleScopePlugin")
const InlineChunkHtmlPlugin = require("@monorepo/react-ssr-dev-utils/InlineChunkHtmlPlugin")
const InterpolateHtmlPlugin = require("@monorepo/react-ssr-dev-utils/InterpolateHtmlPlugin")
...
// check if this is going to be injected as a micro-frontend so that framework libraries should not being bundled
...
module.exports = function (webpackEnv) {
    ...
    const publicPath = isEnvProduction ? `${env.raw.ASSETS_PATH}/` : isEnvDevelopment && "/"
    ...
    return {
        ...
        output: {
            ...
            // filename: isEnvProduction ? "static/js/[name].[chunkhash:8].js" : isEnvDevelopment && "static/js/bundle.js", // OLD
            ...
            // chunkFilename: isEnvProduction // OLD
            //     ? "static/js/[name].[chunkhash:8].chunk.js" // OLD
            //     : isEnvDevelopment && "static/js/[name].chunk.js", // OLD
            ...
            rules: [
                ...
                // It's important to do this before Babel processes the JS.
                {
                    ...
                    use: [
                        {
                            options: {
                                formatter: require.resolve("@monorepo/react-ssr-dev-utils/eslintFormatter"),
