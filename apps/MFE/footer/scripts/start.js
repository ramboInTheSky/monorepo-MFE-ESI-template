...
const {
    ...
    printInstructions,
    createCompiler,
} = require("@monorepo/react-ssr-dev-utils/webpackUtils")
...
let appPort = parseInt(process.env.PORT, 10) || 3002
let appUrls
let devPort = parseInt(process.env.DEV_PORT, 10) || 3200
let devUrls
...
checkBrowsers(paths.appPath, isInteractive)
    ...
    .then(port => {
        ...
        clientConfig.entry = [
            `@monorepo/react-ssr-dev-utils/webpackHotDevClient?devPort=${devPort}`,
            ...clientConfig.entry,
        ]
