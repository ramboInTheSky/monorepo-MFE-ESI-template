...
import {BASELINECSS_GENERATE_CSS_ITEM_NUMBER, BASELINECSS_MATERIALUI, JSS_SERVERSIDE} from "../../../config/settings"
...
const cssMiddleware = async (req: any, res: Response, _next: NextFunction) => {
    ...
    try {
        ...
        const scopedCSSClassname = `${
            serverSideProps.appScope ? serverSideProps.appScope.split("static")[0].substring(0, 6) : "reviewstars"
        }`
