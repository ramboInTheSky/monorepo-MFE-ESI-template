...
const mockResponse = {status: jest.fn(_statusCode => ({send: mockSend}))}
...
describe("Given a renderMiddleware", () => {
    describe("When running as middleware", () => {
        beforeAll(async done => {
            await renderMiddleware(mockRequest as any, mockResponse as any)
            done()
        })
    ...
    describe("When an error is thrown", () => {
        beforeAll(async done => {
            ...
            await renderMiddleware(mockErrorRequest as any, mockResponse as any)
            done()
        })
