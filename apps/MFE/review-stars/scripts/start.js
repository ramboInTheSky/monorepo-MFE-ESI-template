...
const {choosePort, prepareUrls, printInstructions, createCompiler} = require("react-ssr-dev-utils/webpackUtils")
...
let appPort = parseInt(process.env.PORT, 10) || 3007
let appUrls
...
checkBrowsers(paths.appPath, isInteractive)
    ...
    .then(port => {
        ...
        clientConfig.entry = [`react-ssr-dev-utils/webpackHotDevClient?devPort=${devPort}`, ...clientConfig.entry]
