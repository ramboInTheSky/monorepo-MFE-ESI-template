...
describe("themeMiddleware", () => {
        ...
        const mockResponse = {
            locals: {
                configuration: {
                    ...
                    "header.frontend.themeVersion": {Value: "v3.3.3"},
                    "header.frontend.variant": {Value: "default"},
                },
            },
        }
        ...
        const mockResponse = {
            locals: {
                configuration: {
                    "header.frontend.appCacheTTL": {Value: 22},
                    "header.frontend.themeVersion": {Value: "v3.3.3"},
                    "header.frontend.variant": {Value: "inverted"},
                },
            },
        }
    ...
    describe("default version of themes without configuration object inside locals object", () => {
        ...
        it("should fall back 14.0.0 version of themes", () => {
            // eslint-disable-next-line @typescript-eslint/unbound-method
            expect(mockAxios.get).toHaveBeenCalled()

            // eslint-disable-next-line @typescript-eslint/unbound-method
            expect(mockAxios.get).toHaveBeenCalledWith(
                "https://ecmbrowsefdsxeuw.azurefd.net/static-content/theme/v14.0.0/amido_theme.json",
            )
        })
        it("Should call mockNext", () => {
            expect(mockNext).toHaveBeenCalled()
