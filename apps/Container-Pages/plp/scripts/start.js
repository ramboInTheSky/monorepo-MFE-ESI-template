...
const chalk = require("@monorepo/react-ssr-dev-utils/chalk")
const openBrowser = require("@monorepo/react-ssr-dev-utils/openBrowser")
const clearConsole = require("@monorepo/react-ssr-dev-utils/clearConsole")
const checkRequiredFiles = require("@monorepo/react-ssr-dev-utils/checkRequiredFiles")
const {choosePort, prepareUrls, printInstructions, createCompiler} = require("@monorepo/react-ssr-dev-utils/webpackUtils")
...
if (!checkRequiredFiles([paths.appHtml, paths.appClientIndexJs, paths.appServerIndexJs])) {
    process.exit(1)
}
...
let appUrls
let devPort = parseInt(process.env.DEV_PORT, 10) || 3300
let devUrls
...
const {checkBrowsers} = require("@monorepo/react-ssr-dev-utils/browsersHelper")
checkBrowsers(paths.appPath, isInteractive)
    ...
    .then(port => {
        ...
        clientConfig.entry = [`@monorepo/react-ssr-dev-utils/webpackHotDevClient?devPort=${devPort}`, ...clientConfig.entry]
        ...
        const clientCompiler = createCompiler(webpack, clientConfig, "Client", true, useTypeScript, devSocket)
        const serverCompiler = createCompiler(webpack, serverConfig, "Server", false, useTypeScript, devSocket)
