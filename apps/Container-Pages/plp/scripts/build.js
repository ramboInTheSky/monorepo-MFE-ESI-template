...
const FileSizeReporter = require("@monorepo/react-ssr-dev-utils/FileSizeReporter")
const formatWebpackMessages = require("@monorepo/react-ssr-dev-utils/formatWebpackMessages")
const printBuildError = require("@monorepo/react-ssr-dev-utils/printBuildError")
const printHostingInstructions = require("@monorepo/react-ssr-dev-utils/printHostingInstructions")
    ...
    return new Promise((resolve, reject) => {
        clientCompiler.run((clientErr, clientStats) => {
            ...
            serverCompiler.run((serverErr, serverStats) => {
                ...
                console.log("serverMessages.errors", serverMessages.errors)
